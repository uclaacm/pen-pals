...
function ExerciseComplete({ exerciseName, onComplete }: ExerciseCompleteInputs): JSX.Element {
  return (
    <div className="exercisecomplete-container">
      ...
      <p></p>
      <button className="exercisecomplete-continue-button" onClick={onComplete}>Continue</button>
    </div>
  );
}
